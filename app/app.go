...
type App struct {
	*baseapp.BaseApp
	...
	ScopedBookversesKeeper capabilitykeeper.ScopedKeeper
	BookversesKeeper       Bookverseskeeper.Keeper
...
func New(
	...
	scopedBookversesKeeper := app.CapabilityKeeper.ScopeToModule(Bookversestypes.ModuleName)
	app.ScopedBookversesKeeper = scopedBookversesKeeper
	app.BookversesKeeper = *Bookverseskeeper.NewKeeper(
		appCodec,
		keys[Bookversestypes.StoreKey],
		keys[Bookversestypes.MemStoreKey],
		app.IBCKeeper.ChannelKeeper,
		&app.IBCKeeper.PortKeeper,
		scopedBookversesKeeper,
		app.BankKeeper,
	)
	BookversesModule := Bookverses.NewAppModule(appCodec, app.BookversesKeeper)
	...
	ibcRouter.AddRoute(Bookversestypes.ModuleName, BookversesModule)
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(Bookversestypes.ModuleName)
